...
#if defined(OQS_ENABLE_SIG_ml_dsa_87_aarch64_neon)
extern int PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_NEON_keypair(uint8_t *pk, uint8_t *sk);
extern int PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_NEON_signature(uint8_t *sig, size_t *siglen, const uint8_t *m, size_t mlen, const uint8_t *ctx, size_t ctxlen, const uint8_t *sk);
extern int PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_NEON_verify(const uint8_t *sig, size_t siglen, const uint8_t *m, size_t mlen, const uint8_t *ctx, size_t ctxlen, const uint8_t *pk);
#endif

#if defined(OQS_ENABLE_SIG_ml_dsa_87_aarch64_sve2)
extern int PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_SVE2_keypair(uint8_t *pk, uint8_t *sk);
extern int PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_SVE2_signature(uint8_t *sig, size_t *siglen, const uint8_t *m, size_t mlen, const uint8_t *ctx, size_t ctxlen, const uint8_t *sk);
extern int PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_SVE2_verify(const uint8_t *sig, size_t siglen, const uint8_t *m, size_t mlen, const uint8_t *ctx, size_t ctxlen, const uint8_t *pk);
#endif
...
#endif /* OQS_DIST_BUILD */
#elif defined(OQS_ENABLE_SIG_ml_dsa_87_aarch64_sve2) || defined(OQS_ENABLE_SIG_ml_dsa_87_aarch64_neon)
#if defined(OQS_DIST_BUILD)
	if (OQS_CPU_has_extension(OQS_CPU_EXT_ARM_SVE2)) {
#if defined(OQS_ENABLE_SIG_ml_dsa_87_aarch64_sve2)
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_SVE2_keypair(public_key, secret_key);
#else
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_C_keypair(public_key, secret_key);
#endif
...
#endif /* OQS_DIST_BUILD */
#if defined(OQS_ENABLE_SIG_ml_dsa_87_aarch64_neon)
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_NEON_keypair(public_key, secret_key);
#else
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_C_keypair(public_key, secret_key);
#endif
#if defined(OQS_DIST_BUILD)
...
OQS_API OQS_STATUS OQS_SIG_ml_dsa_87_sign(uint8_t *signature, size_t *signature_len, const uint8_t *message, size_t message_len, const uint8_t *secret_key) {
	...
	if (OQS_CPU_has_extension(OQS_CPU_EXT_ARM_SVE2)) {
#if defined(OQS_ENABLE_SIG_ml_dsa_87_aarch64_sve2)
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_SVE2_signature(signature, signature_len, message, message_len, NULL, 0, secret_key);
#else
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_C_signature(signature, signature_len, message, message_len, NULL, 0, secret_key);
#endif
	} else if (OQS_CPU_has_extension(OQS_CPU_EXT_ARM_NEON)) {
#endif /* OQS_DIST_BUILD */
#if defined(OQS_ENABLE_SIG_ml_dsa_87_aarch64_neon)
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_NEON_signature(signature, signature_len, message, message_len, NULL, 0, secret_key);
#else
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_C_signature(signature, signature_len, message, message_len, NULL, 0, secret_key);
#endif
#if defined(OQS_DIST_BUILD)
...
OQS_API OQS_STATUS OQS_SIG_ml_dsa_87_verify(const uint8_t *message, size_t message_len, const uint8_t *signature, size_t signature_len, const uint8_t *public_key) {
	...
	if (OQS_CPU_has_extension(OQS_CPU_EXT_ARM_SVE2)) {
#if defined(OQS_ENABLE_SIG_ml_dsa_87_aarch64_sve2)
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_SVE2_verify(signature, signature_len, message, message_len, NULL, 0, public_key);
#else
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_C_verify(signature, signature_len, message, message_len, NULL, 0, public_key);
#endif
	} else if (OQS_CPU_has_extension(OQS_CPU_EXT_ARM_NEON)) {
#endif /* OQS_DIST_BUILD */
#if defined(OQS_ENABLE_SIG_ml_dsa_87_aarch64_neon)
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_NEON_verify(signature, signature_len, message, message_len, NULL, 0, public_key);
#else
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_C_verify(signature, signature_len, message, message_len, NULL, 0, public_key);
#endif
#if defined(OQS_DIST_BUILD)
...
OQS_API OQS_STATUS OQS_SIG_ml_dsa_87_sign_with_ctx_str(uint8_t *signature, size_t *signature_len, const uint8_t *message, size_t message_len, const uint8_t *ctx_str, size_t ctx_str_len, const uint8_t *secret_key) {
	...
	if (OQS_CPU_has_extension(OQS_CPU_EXT_ARM_SVE2)) {
#if defined(OQS_ENABLE_SIG_ml_dsa_87_aarch64_sve2)
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_SVE2_signature(signature, signature_len, message, message_len, ctx_str, ctx_str_len, secret_key);
#else
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_C_signature(signature, signature_len, message, message_len, ctx_str, ctx_str_len, secret_key);
#endif
	} else if (OQS_CPU_has_extension(OQS_CPU_EXT_ARM_NEON)) {
#endif /* OQS_DIST_BUILD */
#if defined(OQS_ENABLE_SIG_ml_dsa_87_aarch64_neon)
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_NEON_signature(signature, signature_len, message, message_len, ctx_str, ctx_str_len, secret_key);
#else
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_C_signature(signature, signature_len, message, message_len, ctx_str, ctx_str_len, secret_key);
#endif
#if defined(OQS_DIST_BUILD)
...
OQS_API OQS_STATUS OQS_SIG_ml_dsa_87_verify_with_ctx_str(const uint8_t *message, size_t message_len, const uint8_t *signature, size_t signature_len, const uint8_t *ctx_str, size_t ctx_str_len, const uint8_t *public_key) {
	...
	if (OQS_CPU_has_extension(OQS_CPU_EXT_ARM_SVE2)) {
#if defined(OQS_ENABLE_SIG_ml_dsa_87_aarch64_sve2)
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_SVE2_verify(signature, signature_len, message, message_len, ctx_str, ctx_str_len, public_key);
#else
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_C_verify(signature, signature_len, message, message_len, ctx_str, ctx_str_len, public_key);
#endif
	} else if (OQS_CPU_has_extension(OQS_CPU_EXT_ARM_NEON)) {
#endif /* OQS_DIST_BUILD */
#if defined(OQS_ENABLE_SIG_ml_dsa_87_aarch64_neon)
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_AARCH64_NEON_verify(signature, signature_len, message, message_len, ctx_str, ctx_str_len, public_key);
#else
		return (OQS_STATUS) PQCP_MLDSA_NATIVE_MLDSA87_C_verify(signature, signature_len, message, message_len, ctx_str, ctx_str_len, public_key);
#endif
#if defined(OQS_DIST_BUILD)
